      ...
      <div className="mx-auto max-w-site">
        ...
        <ol className="relative mt-14">
          ...
          {roles.map((role, index) => (
            ...
            >
              <p className="pl-8 text-sm text-muted md:pr-10 md:pl-0 md:text-right">
                {role.dates}
              </p>

              <div className="pl-8 md:pl-12">
                <span
                  className={`absolute left-0 top-1.5 h-4 w-4 rounded-full border-2 border-ink bg-paper md:left-[11.5rem] md:-ml-2 ${
                    role.current ? "bg-ink" : ""
                  }`}
                  aria-hidden="true"
                >
